...
class OpenAIAsyncStreamWrapper:
    def __init__(self, async_stream: AsyncStream, accumulator, model_from_response, update_accumulator_streaming, final_processing_and_logging):
...
class OpenAIStreamWrapper:
    def __init__(self, stream: Stream, accumulator, model_from_response, update_accumulator_streaming, final_processing_and_logging):
        self._stream = stream
        self._final_processing_and_logging = final_processing_and_logging
        self._update_accumulator_streaming = update_accumulator_streaming
        self._accumulator = accumulator
